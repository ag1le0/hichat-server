...
function getTimeSpan(time) {
    var time2 = moment(time, "YYYY/MM/DD HH:mm:ss");

    var getH = time2.format("HH:mm");
    if(getH < "07:30"){
        var time3 = new Date((time2.toDate().setDate(time2.toDate().getDate()-1)));
        return moment(time3).format("YYYY/MM/DD") + " NIGHT";
    }
    else if(getH >= "07:30" && getH < "19:30"){
        return time2.format("YYYY/MM/DD") + " DAY";
    }
    else{
        return time2.format("YYYY/MM/DD") + " NIGHT";
    }
}